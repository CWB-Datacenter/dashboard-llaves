                ...
                <List sx={{ width: '100%' }}>
                    {files.map((file) => (
                        <ListItem key={file.id} >
                            ...
                            <ListItemText primary={file.nombre_archivo} secondary={file.fecha_subida} 
                                sx={{
                                    '& .MuiListItemText-primary': {
                                        fontSize: '.8em', // Cambia el tamaño de fuente de 'primary'
                                        fontStyle: 'italic', // Puedes aplicar más propiedades de estilo aquí
                            ...
                            <ListItemIcon onClick={() => handleDownload(file.id)} sx={{ minWidth: 'auto', marginRight: 0, cursor: 'pointer' }}>
